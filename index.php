...
$empty_product = (object)[
  ...
  "price"=>"1700",
  "category"=>"camera",
  "thumbnail"=>"C_R6_1.jpg",
  "images"=>"img/C_R6_1.jpg"
];
...
HTML;
    ...
    <form method="post" action="{$_SERVER['PHP_SELF']}?id=$id&action=update">
        ...
        <div class="form-control">
            ...
            <input class="form-input" name="product-price" id="product-price" type="Number"  min="0" max="4000" step="0.01" value="$o->price" placeholder="Enter the Product Price"> 
        </div>
