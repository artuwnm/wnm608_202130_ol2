...
<form method="post" action="{$_SERVER['PHP_SELF']}?id=$id&action=$createorupdate">
    ...
    <div class="form-control">
        <label class="form-control" for="product-name">Name</label>
        <input class="form-input" name="product-name" id="product-name" type="text" value="$o->name" placeholder="Enter the Product Name">
    </div>
    <div class="form-control">
        <label class="form-control" for="product-price">Price</label>
        <input class="form-input" name="product-price" id="product-price" type="Number" step="0.01" min="0" max="1000" alue="$o->price" placeholder="Enter the Product Price">
    </div>
    <div class="form-control">
        <label class="form-control" for="product-category">Category</label>
    ...
    <div class="form-control">
        <label class="form-control" for="product-description">Description</label>
    ...
    <div class="form-control">
        <label class="form-control" for="product-thumbnail">Thumbnail</label>
        <input class="form-input" name="product-thumbnail" id="product-thumbnail" type="text" value="img/$o->thumbnail" placeholder="Enter the Product Thumbnail">
    </div>
    <div class="form-control">
        <label class="form-control" for="product-images">Other Images</label>
        <input class="form-input" name="product-images" id="product-images" type="text" value="img/$o->images" placeholder="Enter the Product Other Images">
    </div>
    <div class="form-control">
            ...
            if(isset($_GET['id'])) {
                ...
                showProductPage(
                    $_GET['id']=="new" ?
                        ...
                        print_r(makeQuery(makeConn(),"SELECT * FROM `products` WHERE `id`=".$_GET['id']))
                );
            } else {
