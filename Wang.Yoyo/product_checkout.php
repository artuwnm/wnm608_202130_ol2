			...
			<form class="form">
				...
				<div class="form-control">
				    ...
				    <div class="col-xs-12 col-md-6">												
					  ...
					  <input id="address-state" type="text" placeholder="City" class="form-input">
				    </div>
				</div>
			</div>
			<div class="form-control">
				...
				<div class="form-control">											
					<label for="paymeny-zip" class="form-label">Zip Code</label>
					<input id="paymeny-zip" type="text" placeholder="Zip Code" class="form-input">
				 </div>
			  <div class="form-control">
